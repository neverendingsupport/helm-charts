...
| prometheusRule | object | `{"additionalLabels":{},"annotations":{},"enabled":false,"rules":[]}` | Configure a PrometheusRule for evaluating alerting rules against scraped metrics. |
...
| prometheusRule.rules | list | `[]` | List of Prometheus alerting rules. Rule fields are rendered as Helm templates. |
