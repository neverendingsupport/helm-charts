...
| autoscaling | object | `{"enabled":false,"maxReplicas":100,"minReplicas":1,"targetCPUUtilizationPercentage":80,"targetMemoryUtilizationPercentage":null}` | section for configuring autoscaling. More information can be found here: https://kubernetes.io/docs/concepts/workloads/autoscaling/ |
| autoscaling.enabled | bool | `false` | enable autoscaling |
| autoscaling.maxReplicas | int | `100` | maximum number of replicas to run |
...
| awsEnvSecrets.env_secret_name | string | `"erc-env"` | name of secret to store AWS secretmanager values within |
...
| redis | object | `{"enabled":false}` | Redis subchart configuration values. Default values are at https://artifacthub.io/packages/helm/bitnami/redis |
